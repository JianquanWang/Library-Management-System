...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>Hello, XXX!</h1>
                <p>Please modify the book information carefully...</p>
            </div>
            <div class="page-header">
                <h3><small>Update</small></h3>
            </div>
            <% 
			String bookId = request.getParameter("bookId");
			pageContext.setAttribute("bookId", bookId);
			%>
            <form class="form-horizontal" action="${pageContext.request.contextPath}/updateBook?bookId=${bookId}" method="post" enctype="multipart/form-data">
			
                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">Book NO.</label>
                    <div class="col-sm-8">
                        <input name="bookId" class="form-control" id="bookId" readonly="readonly" value="${request.getAttribute("bookId")}">
                    </div>
                </div>
                <div class="form-group">
